...
local pack = util.emoji.get("database/fefxp/emoji.json")
...
Character.section = almanac.get("database/fefxp/fefxp.json")

Character.helper_job_base = true
Character.helper_job_growth = true
Character.helper_job_cap = true

Character.helper_portrait = "database/fefxp/images"
...
function Character:apply_color(infobox)
    if self.route ~= nil and box_color[self.route] ~= nil then
        ...
        infobox:image("icon", string.format("database/fefxp/icon_%s.png", self.route) )
    end
end
---------------------------------------------------
-- Job --
...
Job.section = almanac.get("database/fefxp/job.json")
...
Skill.section = almanac.get("database/fefxp/skill.json")
...
Item.section = almanac.get("database/fefxp/item.json")
...
Redirect.section = almanac.get("database/fefxp/redirect.json")
...
-- Fire Emblem Fates: Crossed Paths
Fefxp.__index = Fefxp
setmetatable(Fefxp, Character)

Fefxp.section = almanac.get("database/fefxp/fefxp.json")
