...
local pack = util.emoji.get("database/pt/emoji.json")
...
Character.section = almanac.get("database/pt/char.json")

Character.helper_portrait = "database/pt/images"

Character.avatar_id = "robin"
Character.avatar_child = "morgan"
Character.avatar_mod = util.file.json_read("almanac/game/data/avatar.json").pt
...
function Character:show_set()
    ...
    if util.value_in_table(set, "ptavatar") then
        local infobox = Infobox:new({title = self.data.name})
...
Job.section = almanac.get("database/pt/job.json")
...
Skill.section = almanac.get("database/pt/skill.json")
...
Item.section = almanac.get("database/pt/item.json")
...
Shop.section = almanac.get("database/pt/shop.json")
